...
typedef C2DXAndroidOnPayListener<C2DXAndroidPayOrder, C2DXAndroidAliApi> PayOrderAli;
typedef C2DXAndroidOnPayListener<C2DXAndroidPayOrder, C2DXAndroidWxApi> PayOrderWx;
typedef C2DXAndroidOnPayListener<C2DXAndroidTicketOrder, C2DXAndroidAliApi> TicketOrderAli;
typedef C2DXAndroidOnPayListener<C2DXAndroidTicketOrder, C2DXAndroidWxApi> TicketOrderWx;
